...
<div class="nav-row">
        ...
        <div style="margin-top:20px;padding:16px 20px;border-radius:14px;border:1px dashed var(--border-subtle);background:var(--accent-subtle);display:flex;align-items:center;gap:16px;"learn-inline-controls">
    ...
    <div class="copyright" id="copyright">
        ...
        <span class="clickable" onclick="openAdminModal()" style="font-size:0.72rem;margin-left:8px;cursor:pointer;opacity:0.5;" title="管理员入口">©</span>
    </div>
</main>
